package  
{
	...
	public class DemandBtn extends MovieClip 
	{
		...
		private const COLUMN_NAME:String = "checked_demand";
		private var _isCheck:Boolean = false;
		
		public function DemandBtn() 
		{
		...
		private function btnClick(e:MouseEvent):void
		{
			...
			var checked_sponsor_ids:Array = cm_scene.checkedDemandSponsorIds();			
			...
			cm_scene.callUpdateCheckedInformation(COLUMN_NAME, cm_scene.checkedDemandSponsorIds().toString());
		}
