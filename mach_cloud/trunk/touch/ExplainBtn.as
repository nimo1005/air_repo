package  
{
	...
	public class ExplainBtn extends MovieClip 
	{
		...
		private const COLUMN_NAME:String = "checked_explain";
		private var _isCheck:Boolean = false;
		
		public function ExplainBtn() 
		{
		...
		private function btnClick(e:MouseEvent):void
		{
			...
			var checked_sponsor_ids:Array = cm_scene.checkedExplainSponsorIds();
			...
			cm_scene.callUpdateCheckedInformation(COLUMN_NAME, cm_scene.checkedExplainSponsorIds().toString());
		}
