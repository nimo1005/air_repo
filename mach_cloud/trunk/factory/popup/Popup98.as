package  
{
	...
	public class Popup98 extends PopupBaseScene 
	{
		
		public function Popup98() 
		{
		...
		*/
		private function popupOkClick(e:MouseEvent):void
		{
			...
			Remote.callRemote2("fact.Mdms98Panel", Mdms98PanelResult, obj);
		}
		
		private function Mdms98PanelResult(e:Object):void
		{
		...
		private function MdmsPopupInfoResult(e:Object):void
		{
			...
			digit1.initCount(split_val[0]);
			digit1m.initCount(split_val[2]);
			...
			udigit1.initCount(split_val2[0]);
			udigit1m.initCount(split_val2[2]);
		...
		public function mdmsDefaultValResult2(e:Event):void
		{
			...
			udigit1.initCount(split_val[0]);
			udigit1m.initCount(split_val[2]);
		}
