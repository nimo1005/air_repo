package  
{
	 ...
	 * @author t
	 */
	public class BatteryBtn26 extends BaseSeibiBtn
	{
		private var btn_info:Object;
		
		public function BatteryBtn26() 
		{
		...
		/*
		 * このボタン(BatteryBtn26)は、整備項目としてレジに出してはいけない（レジへ出さない為に、ment_sigに青の状態をいれる）
		 * chk_idが169～181のものは整備項目としてあげない、整備項目としてあげるバッテリーは150～162
		*/
